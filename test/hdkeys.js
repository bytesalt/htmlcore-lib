...
var HDPrivateKey = htmlcore.HDPrivateKey;
var HDPublicKey = htmlcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = htmlcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(htmlcore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(htmlcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      htmlcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = htmlcore.PublicKey.fromPoint;
      htmlcore.PublicKey.fromPoint = function() {
        htmlcore.PublicKey.fromPoint = unstubbed;
