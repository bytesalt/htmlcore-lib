...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://htmlcore.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by htmlcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a htmlcore Address object. The
 * same is true for `script`, which can be a string or a htmlcore Script.
 *
